    ...
    <div className="shell pb-32 pt-32 md:pb-44 md:pt-40">
      ...
      <div className="mt-16 grid gap-16 md:mt-24 lg:grid-cols-12 lg:gap-12">
        <aside className="flex flex-col gap-12 lg:col-span-4">
          <ul className="flex flex-col gap-6">
            {channels.map(({ icon: Icon, label, value, href, external }) => (
              <li key={label} className="flex items-start gap-4">
                <span className="grid size-11 shrink-0 place-items-center rounded-full glass text-indigo-hi">
                ...
                <div className="min-w-0">
                  ...
                  {href ? (
                    <a
                      ...
                      className="link-underline inline-flex items-center gap-1 break-all text-ink"
                    >
                      {value}
          ...
          <div className="glass-violet rounded-[var(--radius-panel)] p-6 md:p-8">
